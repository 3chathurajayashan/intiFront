...
export default function UserLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Navigate after a short delay to allow notification to be seen
      setTimeout(() => {
        navigate("/");
      }, 1500);
    } catch (err) {
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden transform transition-all duration-300 hover:shadow-2xl">
        ...
        <div className="bg-gray-50 py-4 px-6 rounded-b-2xl">
          <div className="flex items-center justify-center space-x-4">
            <button className="p-2 rounded-full bg-white shadow-sm border border-gray-200 hover:shadow-md transition duration-200">
